...
main(int argc, char** argv)
{
    ...
    // fragment the file
    Fragment(input_file, *output_stream, cursors, fragment_duration, timescale?timescale:AP4_FRAGMENTER_OUTPUT_MOVIE_TIMESCALE, selected_track_id, create_segment_index, copy_udta);
